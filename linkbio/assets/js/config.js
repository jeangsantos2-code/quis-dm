(function () {
  window.CN9_LINKBIO_CONFIG = Object.freeze({
    ...
    CARE_TEAM_MESSAGE: "Olá, vim pelo link da bio do Jean e preciso de ajuda para escolher por onde começar.",
    ENTRY_POINT: "link_bio_page",
    DEFAULT_ATTRIBUTION: Object.freeze({
      utm_source: "instagram",
      utm_medium: "organic_social",
      utm_campaign: "casamento_nota_9_ecossistema",
      utm_content: "link_bio",
      ref: "instagram_bio"
    }),
    ALLOWED_ATTRIBUTION_KEYS: Object.freeze([
      "utm_source",
      "utm_medium",
      "utm_campaign",
      "utm_content",
